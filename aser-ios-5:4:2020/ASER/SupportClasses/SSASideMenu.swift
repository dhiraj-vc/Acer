    ...
    fileprivate func getSideViewController(_ viewController: UIViewController) -> SSASideMenu? {
        if let parent = viewController.parent {
            if parent is SSASideMenu {
                ...
                //                let extractedExpr = getSideViewController(parent)
...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    func _presentLeftMenuViewController() {
        presentMenuViewContainerWithMenuViewController(DrawerVC())
...
//        showRightMenuViewController()
    ...
    fileprivate func animateMenuViewController(_ side: SSASideMenuSide) {
        ...
        if side == .left {
            ...
            // himanshu
            let centerX = UIInterfaceOrientation.landscapeLeft
            //                UIInterfaceOrientationIsLandscape(UIApplication.shared.statusBarOrientation) ?  centerXLandscape : centerXPortrait
            
            //himanshu
            //        contentViewContainer.center = CGPoint(x: centerX, y: contentViewContainer.center.y)
            
            contentViewContainer.center = CGPoint(x: CGFloat(centerX.rawValue), y: contentViewContainer.center.y)
            ...
            let centerX = UIInterfaceOrientation.landscapeRight
            contentViewContainer.center = CGPoint.init(x: CGFloat(centerX.rawValue), y: contentViewContainer.center.y)
            //himanshu
    ...
    fileprivate func hideMenuViewController(_ animated: Bool) {
        ...
        visibleMenuViewController?.navigationController?.isNavigationBarHidden = true
    ...
    override func viewDidLoad() {
        ...
        contentViewController?.navigationController?.navigationBar.isHidden = true
    ...
    fileprivate func hideViewController(_ targetViewController: UIViewController) {
        ...
        targetViewController.navigationController?.isNavigationBarHidden = true
    ...
    override func willAnimateRotation(to toInterfaceOrientation: UIInterfaceOrientation, duration: TimeInterval) {
        ...
        if visible {
            ...
            if leftMenuVisible {
                ...
                let centerXLandscape = CGFloat(contentViewInLandscapeOffsetCenterX) + (iOS8 ? CGFloat(view.frame.width) : CGFloat(view.frame.height))
                let centerXPortrait = CGFloat(contentViewInPortraitOffsetCenterX) + CGFloat(view.frame.width)
                //                let cen = UIInterfaceOrientationIsLandscape(UIApplication.shared.statusBarOrientation) ? centerXLandscape : centerXPortrait
                ...
                let centerX = UIInterfaceOrientation.landscapeLeft
                center = CGPoint.init(x: CGFloat(centerX.rawValue), y: contentViewContainer.center.y)
