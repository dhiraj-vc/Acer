...
class NotificationVC: UIViewController {
    ...
    var notificationVMObj = NotificationVM()
    ...
    override func viewWillAppear(_ animated: Bool) {
        notificationVMObj.arrNotificationModel.removeAll()
        notificationVMObj.getUserNotification {
            if self.notificationVMObj.arrNotificationModel.count>0{
