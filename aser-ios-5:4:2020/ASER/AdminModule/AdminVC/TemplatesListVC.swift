...
class TemplatesListVC: UIViewController {
    //MARK:- Outlets
    @IBOutlet weak var bottomBarView: UIView!
    @IBOutlet weak var topBarView: UIView!
    @IBOutlet weak var tblList: UITableView!
    var templateListVMObj = TemplateListVM()
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(refreshTemplateList), name: NSNotification.Name("RefreshTemplateList"), object: nil)
        templateListVMObj.getTemplateList {
            self.tblList.reloadData()
        }
    }
    @objc func refreshTemplateList(){
        templateListVMObj.getTemplateList {
            self.tblList.reloadData()
        }
    }
